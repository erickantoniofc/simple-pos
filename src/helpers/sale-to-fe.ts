...
export const saleToFe = (sale: Sale, branch: Branch, pos: PosPoint, company: Company): FacturaElectronica => {
    ...
    const fe = {
        identificacion: {
            ...
            numeroControl: '', // Will be generated by sign-dte endpoint
            codigoGeneracion: sale.id ?? "",
